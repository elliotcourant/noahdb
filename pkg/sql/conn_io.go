...
func (e ExecStmt) PGCommand() *ast.Stmt {
	return nil
}
...
func (e ExecPortal) PGCommand() *ast.Stmt {
	return nil
}
...
func (e PrepareStmt) PGCommand() *ast.Stmt {
	return &e.PGQuery
}
...
func (e DescribeStmt) PGCommand() *ast.Stmt {
	return nil
}
...
func (e BindStmt) PGCommand() *ast.Stmt {
	return nil
}
...
func (e DeletePreparedStmt) PGCommand() *ast.Stmt {
	return nil
}
...
func (e Sync) PGCommand() *ast.Stmt {
	return nil
}
...
func (e Flush) PGCommand() *ast.Stmt {
	return nil
}
...
func (e CopyIn) PGCommand() *ast.Stmt {
	return nil
}
...
func (e DrainRequest) PGCommand() *ast.Stmt {
	return nil
}
...
func (e SendError) PGCommand() *ast.Stmt {
	return nil
}
